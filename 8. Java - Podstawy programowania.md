...
// Ponowna próba wypożyczenia czwartej książki – tym razem powinna się udać
aga.borrowBook(book4); // Oczekiwany sukces
...
// Tomek próbuje wypożyczyć książkę, którą już ma Aga – powinno się nie udać
tomek.borrowBook(book4); // Niepowodzenie – książka jest już wypożyczona
